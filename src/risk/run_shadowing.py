...
def create_args():
    ...
    config_specification.add_argument('--recording_name', default="09",
...
if __name__ == '__main__':
    ...
    building_grid_size = 5  # Adjust this value based on your scenario
    car_grid_size = 5
            ...
            if is_vehicle and track not in parking_vehicles:
                ...
                for other_track in other_tracks:
                    ...
                    if(other_is_vru):
                        ...
                        #if other_vru == []:
                        other_vru = veh.update_vru(other_track['xCenter'][other_track_frame_index], other_track['yCenter'][other_track_frame_index], other_track['heading'][other_track_frame_index], i, other_class, other_track['trackId'])
